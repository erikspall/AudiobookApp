package de.erikspall.audiobookapp.domain.provider
...
const val AUTHORITY = "de.erikspall.audiobookapp.domain.provider.CoverProvider"
...
class CoverProvider: ContentProvider() {
    ...
    private lateinit var appDatabase: AudiobookDatabase
    ...
    override fun onCreate(): Boolean {
        ...
        appDatabase = AudiobookDatabase.getDatabase(context!!)
